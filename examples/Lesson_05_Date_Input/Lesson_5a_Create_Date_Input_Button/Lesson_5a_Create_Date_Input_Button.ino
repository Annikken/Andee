...
void setup()
{
  ...
  Andee.setName("DateInput Demo");//Set the name of the Andee. This name will appear in the app
...
void setInitialData()
{
  ...
  dateInputButton.setDefaultDate(15, Jan, 2018); // Format: day, month, year
}
